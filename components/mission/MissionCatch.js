...
const MissionCatch = () => {
  ...
  const [targetGhostPosition, setTargetGhostPosition] = useState({
    x: 0,
    y: 0,
  });
  ...
  useEffect(() => {
    if (canvasRef.current) {
      ...
      const interval = setInterval(moveTargetGhost, 500);
    ...
    <div className={style.missionCatchBox}>
      <div className={style.content}>
        <div
          ...
          style={{ color: countdown <= 4 ? "#E53935" : "$mainColor" }}
        >
